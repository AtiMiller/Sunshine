...
public class TodayWeatherFragment extends Fragment {
    ...
    TextView txt_city_name, txt_humidity, txt_sunrise, txt_sunset, txt_geo_coords, txt_pressure,
    txt_temperature, txt_description, txt_data_time, txt_wind;
    ...
    private void getWeatherInformation() {
        ...
        .subscribe(new Consumer<WeatherResult>() {
            ...
            public void accept(WeatherResult weatherResult) throws Exception {
                ...
                txt_description.setText(new StringBuilder(" Weather in ").append(weatherResult.getName()));
